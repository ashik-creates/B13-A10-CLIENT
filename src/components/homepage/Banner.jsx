...
export default function Banner() {
  ...
  const transportTypes = [
    { id: "bus", label: "Reliable Bus Routes", icon: FaBus, count: "140+ Operators" },
    { id: "train", label: "Intercity Trains", icon: FaTrain, count: "52 Routes" },
    { id: "flight", label: "Domestic Flights", icon: FaPlane, count: "4 Airlines" },
    { id: "launch", label: "River Launches", icon: FaShip, count: "28 Vessels" },
  ];
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="text-left lg:col-span-6 max-w-2xl">
            ...
            <p className="mt-6 text-base text-muted-foreground sm:text-lg leading-relaxed">
              Skip the counter lines completely. Instantly browse fixed schedules, real-time seat maps, and secure digital tickets across our verified network.
            </p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-[11px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-md transition-colors ${
                        isCurrent 
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      ...
                      <div className={`h-8 w-8 rounded-lg flex items-center justify-center border border-divider bg-background transition-all ${
